...
CREATE TABLE identification_evidence_next (
    ...
    source TEXT NOT NULL CHECK(source IN (
        'filename','nfo','tmdb','cache','system','manual-decision','manual-feedback','enhancer'
    )),
    ...
    reason TEXT NOT NULL CHECK(reason IN (
        ...
        'manual.feedback-exact','enhancer.hint.title','enhancer.hint.year',
        'enhancer.hint.media-type','enhancer.hint.episode',
        'enhancer.fallback.disabled','enhancer.fallback.model-unavailable',
        'enhancer.fallback.overloaded','enhancer.fallback.unavailable',
        'enhancer.fallback.timeout','enhancer.fallback.response-too-large',
